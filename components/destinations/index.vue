  ...
  <section class="p-6 sm:p-20 sm:-mt-32 font-poppins">
    ...
    >
      <div>
        <nuxt-img
          format="webp"
          src="https://images.ctfassets.net/lmkdg513arga/3Vhm0NRK3OMQIuSo9EDjnp/71b0844f15fbf5e0bff2751f45f6180e/iStock-539115110.jpg?w=2764&fm=jpg"
          alt="rome"
      ...
      <div>
        <nuxt-img
          format="webp"
          src="https://travel.home.sndimg.com/content/dam/images/travel/fullset/2015/05/28/big-ben-london-england.jpg.rend.hgtvcom.1280.1280.suffix/1491582155388.jpeg"
          alt="london"
          class="w-full h-80 object-cover rounded-t-3xl"
          width="314"
          height="457"
      ...
      <div class="relative">
        <nuxt-img
          format="webp"
          src="https://media-cdn.tripadvisor.com/media/photo-c/1280x250/17/15/6d/d6/paris.jpg"
          alt="europe"
          class="w-full h-80 object-cover rounded-t-3xl"
          width="314"
          height="457"
        ...
        >
          <div class="flex items-center justify-between font-poppins">
            <p class="text-gray-500 font-medium">Paris</p>
