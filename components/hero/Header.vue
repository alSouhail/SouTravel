  ...
  <div class="p-5 sm:px-16 sm:py-6 flex items-center w-full justify-between font-poppins">
    ...
    <div class="hidden lg:flex items-center space-x-20">
      <ul class="flex items-center space-x-12">
        <li>
          <NuxtLink to="#">Destinations</NuxtLink>
        </li>
        <li>
          <NuxtLink to="#">Hotels</NuxtLink>
        </li>
        <li>
          <NuxtLink to="#">Flights</NuxtLink>
        </li>
        <li>
          <NuxtLink to="#">Bookings</NuxtLink>
        </li>
      </ul>
      <ul class="flex items-center space-x-8">
        ...
        <li>
          <NuxtLink to="#" class="border-2 rounded-lg px-3 py-2 border-gray-900">Signup</NuxtLink>
        </li>
      ...
      <DialogPanel
        ...
        <div class="flex items-center justify-between">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">SouTravel</span>
            <Logo />
          </a>
